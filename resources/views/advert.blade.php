                    ...
                    <div class="row" style="margin-top:20px">
                        <div class="col-md-12" >
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="product-desc">{{str_limit('The Corsair Gaming Series GS600 is the ideal price/performance
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane fade in active" id="service-one">
                                ...
                                <section class="container product-info">
                                    ...
                                    for
                                    building or upgrading a Gaming PC. A single +12V rail provides up to 48A of
                                    reliable,
